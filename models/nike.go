...
type NikeProductResponse2 struct {
	Pages struct {
		Prev           string `json:"prev"`
		Next           string `json:"next"`
		TotalPages     int    `json:"totalPages"`
		...
		PublishedContent struct {
			...
			Nodes []struct {
				...
				Properties0 struct {
					...
					ControlOptions string  `json:"controlOptions"`
					AspectRatio    float64 `json:"aspectRatio"`
					VideoID        string  `json:"videoId"`
					Portrait       struct {
						StartImageURL string  `json:"startImageUrl"`
					...
					Title                string `json:"title"`
					PreferredOrientation struct {
						Small  string `json:"small"`
						Large  string `json:"large"`
						Medium string `json:"medium"`
					} `json:"preferredOrientation"`
					CopyID        string        `json:"copyId"`
					Loop          bool          `json:"loop"`
					ProviderID    string        `json:"providerId"`
					AssetID       string        `json:"assetId"`
					...
					StartImage struct {
						...
						ThreadImageOverride string `json:"threadImageOverride"`
						Portrait            struct {
							AspectRatio float64 `json:"aspectRatio"`
							ID          string  `json:"id"`
							Type        string  `json:"type"`
						...
						FeedImageOverride string `json:"feedImageOverride"`
						Landscape         struct {
							AspectRatio float64 `json:"aspectRatio"`
							ID          string  `json:"id"`
							Type        string  `json:"type"`
